...
exports.DEFAULT_PRODUCT_ID = exports.fetchProductById = void 0;
...
var fetchProductById = function (productId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, axios_1.default.get("".concat(API_BASE, "/products/").concat(productId))];
            case 1:
                response = _a.sent();
            ...
            case 2:
                ...
                if (axios_1.default.isAxiosError(error_1) && error_1.response) {
                    throw new Error(error_1.response.data.message || 'Failed to fetch product data');
                }
 ...
 */
exports.DEFAULT_PRODUCT_ID = '98873a7d-1358-45ad-adb7-84ef4bf666af';
